...
My Ruby on Rails project for afshin.herokuapp.com - my tech blog website and work portfolio.
...
* Serve icon-fonts locallycurl -I https://some.cdn.otherdomain.net/media/fonts/somefont.ttf
