...
gem 'jquery-turbolinks'         # fix issue where turbolinks prevents $(document).ready() from working properly
...
group :development, :test do
  ...
  gem 'brakeman', :require => false  # Security vulnerabilities checker
end
